...
## PLEASE ABIDE BY LICENSING TERMS AND CONDITIONS FOR COPYRIGHT BEFORE PROCEEDING WITH THE PROJECT
...
- featured and most viewed tabs my take a few seconds longer to fill in missing views and date due to invidious just not giving them
- subscription, history, and playlist details may not be fully completed as they arent enriched yet
- use ngrok, for my case at least, for ios 3 users if you want pages to refresh whenever you click on them 
- History does work. you just need to login with the device id linked to it, which may be different from the one currently being used to login
...
- channel handle uploads are still experimented. Fixes will come soon. some upload pages may be stuck loading

### Future development
- some missing parts to work I guess
