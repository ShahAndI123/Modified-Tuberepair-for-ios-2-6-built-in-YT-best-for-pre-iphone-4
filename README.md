...
Before you run this, replace the URL that says "YOUR_URL_HERE" in config.py with either your local invidious instance (if you made one. If not, please see bottom for links to get local) or use public invidious instance (["https://yt.chocolatemoo53.com/", "https://invidious.nerdvpn.de/", "https://inv.thepixora.com/"])
