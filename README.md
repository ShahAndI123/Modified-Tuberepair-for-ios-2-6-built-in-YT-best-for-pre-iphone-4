...
- the primary playlists featured videos uses sometimes is very buggy on invidious which shows no videos on that end which is why I added my own playlist as fallback that shows common recommendations, searches, and topics picked
   - if you are using a local instance, it can be fixable by changing your invidious code from https://github.com/iv-org/invidious/issues/5773#issuecomment-4749213309
